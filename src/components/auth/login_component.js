        ...
        return (
            <div>
                ...
                <section className={`form-block form-block--is-${this.state.mode}`}>
                    ...
                    <LoginForm mode={this.state.mode} onSubmit={this.state.mode === 'login'?this.props.onSubmit:this.props.onSubmit2} />
                </section>
            </div>
        )
    }
...
class LoginForm extends React.Component {
    ...
    render() {
        ...
        <form onSubmit={this.props.onSubmit}>
            ...
            <button className="button button--primary full-width mt-3" type="submit">{this.props.mode === 'login' ? 'Log In' : 'Sign Up'}</button>
        </form>
        )
    }
}
...
export {LoginComponent,LoginForm,Input};
// const App = () => (
